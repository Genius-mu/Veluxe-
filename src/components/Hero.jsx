...
const slides = [
  {
    ...
    body:
      "Veluxe is a clean cosmetics house. We craft velvet-finish skin and lip rituals that move with you — from first light to last call.",
  ...
  },
  {
    ...
    body:
      "Pressed in small batches. Squalane, ceramide-3, and oat lipids — never the noise. Every drop earns its place on your shelf.",
  ...
  },
  {
    ...
    body:
      "Built for the in-between — the run to dinner, the unmade morning, the night that turns into Sunday. Wear it your way.",
    ...
    <section className="relative isolate min-h-screen overflow-hidden bg-ink text-paper">
      ...
      <div className="absolute left-6 top-1/2 z-20 hidden -translate-y-1/2 sm:left-10 md:block">
        <div className="flex flex-col items-center gap-10">
          ...
          >
            <ArrowUp className="h-4 w-4 text-coral transition-transform group-hover:-translate-y-0.5" />
          ...
          >
            ...
            <ArrowUp className="h-4 w-4 rotate-180 text-paper/40 transition-transform group-hover:translate-y-0.5" />
          </button>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1400px] flex-col justify-center px-6 pt-32 pb-24 sm:px-10 md:flex-row md:items-center md:gap-12 md:pt-40">
        ...
        <div className="relative flex-1 md:max-w-xl">
          <AnimatePresence mode="wait" custom={dir}>
            ...
            >
              <motion.div variants={textItem} className="mb-5 flex items-center gap-3">
                <span className="h-px w-8 bg-coral" />
                <span className="label-eyebrow text-paper/60">{slide.index}</span>
              </motion.div>
              ...
              <motion.div variants={textItem} className="mt-10">
                <button className="group flex items-center gap-4 text-paper">
    ...
    <div className="relative aspect-[3/4] w-full max-w-[420px]">
      <AnimatePresence mode="wait" custom={direction}>
        <motion.svg
          ...
          initial={{ opacity: 0, scale: 0.96, x: direction > 0 ? 60 : -60 }}
          animate={{ opacity: 1, scale: 1, x: 0 }}
          exit={{ opacity: 0, scale: 0.96, x: direction > 0 ? -60 : 60 }}
          transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
        >
          <defs>
            {/* V-shaped clip — two thick diagonal strokes converging at bottom center (x=200) */}
          ...
          {/* Left stroke of V — coral duotone */}
          ...
          {/* Right stroke of V — teal duotone */}
          ...
          {/* Subtle hairline outlines on the V edges */}
          <polygon
      ...
      {/* Floating eyebrow badge over the cutout */}
